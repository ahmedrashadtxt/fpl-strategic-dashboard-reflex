...
import html
import urllib.parse
from backend.squad_logic import SILHOUETTE_BASE64, get_player_img_url, fmt_num
...
with open("backend/defensive_logic.py", "a", encoding="utf-8") as f:
    import inspect
    f.write("\n\n")
    f.write(inspect.getsource(run_defensive_analysis))
